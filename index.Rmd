...
facility_data <- readr::read_csv(here::here("data/daily/facilities_data_2020_04_16.csv"))
state_data <- readr::read_csv(here::here("data/daily/state_summaries_inm_pos_4_15.csv"))
```
...
```{r, layout="l-page"}
make_state_choropleth_map()
```


```{r, layout="l-page"}
state_data$total_staff_positive <- state_data$total_inm_positive
